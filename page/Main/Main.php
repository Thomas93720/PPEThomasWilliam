    ...
    <body>
        <nav>
            ...
            <div class="logo">
                ...
                <img class = "logo" src = 'image/logo.png' onClick="document.getElementById('audio_play').play(); return false;" alt="image de fond">
            </div>
            <div class="lien">
        ...
        <div class=content>
            ...
            <hr>
            <bR>
            <label>©Prezot And Bonnemoy Industry</label>
        </div>
    </body>
</html>